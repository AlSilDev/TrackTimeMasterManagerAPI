...
class AdminVerificationController extends Controller
{
    ...
    public function getEventAdminVerificationsForVerify(int $eventId)
    {
        return response()->json(DB::table('admin_verifications AS av')
                                //->select('av.id', 'dhf.name AS first_driver', 'dhs.name AS second_driver', 'av.verified', 'av.notes', 'u.name')
                                ->select('av.id', 'av.enrollment_id', 'e.enroll_order', 'e.run_order', 'vh.model AS vehicle_model', 'vh.license_plate AS vehicle_license_plate', 'dhf.name AS first_driver_name', 'dhf.country AS first_driver_country', 'part.first_driver_id AS first_driver_id', 'dhf.license_num AS first_driver_license_num', 'dhf.phone_num AS first_driver_phone_num', 'dhs.name AS second_driver_name', 'dhs.country AS second_driver_country', 'part.second_driver_id AS second_driver_id', 'dhs.license_num AS second_driver_license_num', 'dhs.phone_num AS second_driver_phone_num', 'av.verified', 'av.verified_by', 'vc.name AS vehicle_class', 'vcc.name AS vehicle_category', 'av.notes')
                                ->join('enrollments AS e', 'e.id', 'av.enrollment_id')
